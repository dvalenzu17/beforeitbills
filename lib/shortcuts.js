...
export function setupShortcuts(tt) {
  ...
  // Skip on iOS 26+ - QuickActions.setItems is a void TurboModule method.
  // Any void-method throw on iOS 26 races with Hermes Hades GC and crashes
  // the app inside convertNSExceptionToJSError (KERN_INVALID_ADDRESS).
